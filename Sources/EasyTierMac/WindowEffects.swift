...
final class GlassRenderCoordinator {
    static let shared = GlassRenderCoordinator()
...
final class ManagedVisualEffectHostView: NSView {
    ...
    func tearDown() {
        ...
        GlassRenderCoordinator.shared.unregister(self)
    ...
    override func viewDidMoveToWindow() {
        ...
        GlassRenderCoordinator.shared.register(self)
        reconcileWindowRendering()
    }
